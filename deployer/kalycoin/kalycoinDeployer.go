...
import (
	...
	"github.com/kalycoinproject/solar/b58addr"
...
type Deployer struct {
	...
	*contract.ContractsRepository
	...
	// kalycoin base58 sender address used to create a contract.
...
func (d *Deployer) CreateContract(c *contract.CompiledContract, jsonParams []byte, opts *deployer.Options) (err error) {
	// TODO: dry out similar CreateContract code from eth and kalycoin deployers
	name := opts.Name
